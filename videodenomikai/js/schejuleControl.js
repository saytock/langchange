...
//	var currentTime = eday.getHours() * 100 + eday.getMinutes();
	...
	document.getElementById(month+"月"+date+"日").className = 'currentDay';


	//予定を表示
	var tmp ="<h2>ー本日の予定ー</h2>";
