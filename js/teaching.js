...
/*if((tmpDate==tdate && thour<=(tmpHour2)) || ((tmpDate2)==tdate && thour<=(tmpHour2)) || (tdate<tmpDate2)){
	openDialog("このトークはもう登録できません<br><br>※トーク開始12時間前まで登録ができます");
}

else{*/
openDialog("トークを登録しました。予約され次第、メールが届きます。もう一度ボタンを押すことでキャンセルできます。<br/><br/>※マッチング後のキャンセルではLCコインが1枚減ります");
