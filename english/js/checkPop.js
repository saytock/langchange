			...
			success: function(data,dataType){
				...
				if(data){
					for(var i=0;i<dataArray.length-1;i=i+1){
						msg = prepareTime2(dataArray[i]);
						document.getElementById("dialog"+k).display="none";
						document.getElementById("dialog"+k).innerHTML = msg;
						k=k+1;
						if(k==10){
							break;
						}
...
function prepareTime2(val){
	var tmp = val.slice(18,20);
	var cTime2;
	var cMonth2 = val.slice(11,13);
	var cDate2 = val.slice(14,16);
	...
	cTime2 = "0" + cTime2;
	 ...
	 return val.slice(0,11)+cMonth2+"/"+cDate2+" " + cTime2 + val.slice(20,23)+"<br/>"+val.slice(23);
