...
$tmp = "<center><img class='img-responsive'  src='".$image."' width='160px' height='auto'/></center>,<h2 style='text-align:center'>".$rows["name"]." さん</h2>,".$rows["ticket"]."枚"./*<button onClick='toPayPal()'>購入</button>*/",".$_SESSION["friends"]."人,".$rows["nation"].",".$rows["sex"].",".$rows["birthday"].",".$rows["hobby"].",".$_SESSION["id"].",".$rows["serching"].",";
