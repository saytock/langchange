...
//echo "SELECT type FROM history WHERE userid = '".$_SESSION["id"]."' && year = '".$_POST["year"]."' && date ='".$date."'";	
//echo $rows["type"];
	//出席登録
	if($rows["type"]=="learning"){
//echo "UPDATE learning SET comment = 'c' WHERE userid = '".$_SESSION["id"]."' && learningyear ='".$_POST["year"]."' && learning ='".$date."'";
